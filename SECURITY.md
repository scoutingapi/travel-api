...
Please email **hello@stayingapi.com** with the subject line `SECURITY: travel-api`. Do not open public GitHub issues for security reports. We acknowledge within 72 hours and aim to publish a fix or mitigation within 14 days for confirmed issues.
